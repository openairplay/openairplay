...
sleep 2
echo "sudo apt-get install libavahi-compat-libdnssd-dev python3 python3-pyqt4 python3-qt4 python3-zeroconf"
sudo apt-get install libavahi-compat-libdnssd-dev python3 python3-pyqt4 python3-qt4 python3-zeroconf
